...
public class RecButton extends View {
    ...
    public RecButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RecButton(Context context, AttributeSet attrs, int defStyleAttr) {
